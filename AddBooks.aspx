<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddBooks.aspx.cs" Inherits="Library_Management_System.AddBooks" %>
        ...
        <table class="auto-style22" style="margin: 0px auto 0px auto">
            ...
            <tr>
                <td class="auto-style18" colspan="2">&nbsp;
                    <strong>
                <asp:Button ID="Button1" runat="server"  BorderColor="White" BorderStyle="Solid" BorderWidth="1px" CssClass="custom-button" Text="Add Book" OnClick="Button1_Click" ValidationGroup="MyValidation" />
                </strong>
                </td>
            </tr>
        </table>
